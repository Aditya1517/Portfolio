...
import powerbiLogo from "./assets/tech_logo/powerBI.jpeg";
...
import tensorflowLogo from "./assets/tech_logo/tensor-flow.png";
import kerasLogo from "./assets/tech_logo/keras.png";
import pytorchLogo from "./assets/tech_logo/pytorch.jpeg";
...
export const projects = [
  ...
  },
  {
    ...
    github:
      "https://github.com/Aditya1517/Optimized-Federated-Learning-Based-Malware-Detection-Using-CNN-and-Post-Training-Quantization",
  },
  {
    id: 3,
...
export const blogs = [
  {
    ...
    description:
      "Scalable Food Delivery Web App built with the MERN stack featuring JWT auth, image uploads, Context API, and full deployment. A practical guide with code snippets and tips for real-world devs.",
    image: blog1,
    date: "July 14, 2025",
  ...
  },
  {
    id: 1,
    title:
      "Lessons Learned from Building a Full-Stack E-Commerce App with Razorpay & Stripe Integration",
    description:
      "A hands-on guide to building a full-stack e-commerce app with secure Razorpay and Stripe payment integration using React, Node.js, and MongoDB.",
    image: blog2,
    date: "July 15, 2025",
  ...
  },
  {
    ...
    description:
      "A hands-on guide to recognizing human emotions from speech using deep learning and Python.",
    image: blog3,
    date: "July 13, 2025",
  ...
  },
  {
    id: 3,
    title:
      "Federated Learning with CNN for Edge Malware Detection — A Practical Guide",
    description:
      "A practical guide to deploying Federated Learning with CNNs on Raspberry Pi for real-time, privacy-preserving malware detection in Industrial IoT systems — highlighting architecture, implementation, and key learnings.",
    image: malware,
    date: "July 21, 2025",
  ...
  },
  {
    id: 4,
    title:
      "Excel Basics for Data Analysis: A Beginner’s Guide to Formulas, Functions & Shortcuts",
    description:
      "A beginner-friendly guide to essential Excel functions, formulas, and shortcuts for effective data analysis — covering math, logic, conditional tools, text functions, and worksheet management.",
    image: excel_basics,
    date: "July 23, 2025",
  ...
  },
  {
    id: 5,
    title:
      "Mastering Power Query in Excel: From Basics to Advanced Data Transformation",
    description:
      "A complete beginner-to-advanced guide to Power Query in Excel — learn how to import, clean, transform, and automate data workflows using this powerful no-code ETL tool.",
